        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <span className="text-xl sm:text-2xl font-bold text-white">BIS</span>
            </motion.div>
            ...
            >
              <Link href="/dashboard">
                <button className="px-3 sm:px-6 py-2.5 sm:py-3 bg-emerald-500 hover:bg-emerald-400 text-white text-sm sm:text-base font-semibold rounded-lg transition-all duration-200 flex items-center gap-2 shadow-lg shadow-emerald-500/50 hover:shadow-xl hover:shadow-emerald-500/50 min-h-[44px]">
            ...
            <div className="text-center">
              ...
              >
                <Link href="/dashboard" className="w-full sm:w-auto">
                  <button className="group w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-emerald-500 hover:bg-emerald-400 text-white text-base sm:text-lg font-bold rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-2xl shadow-emerald-500/50 hover:shadow-emerald-500/70 hover:scale-105 min-h-[48px]">
                    Get Started
            ...
            >
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl ${feature.color} flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300`}>
                    ...
                    <div className={`absolute inset-0 rounded-2xl ${feature.color} opacity-0 group-hover:opacity-10 blur-xl transition-opacity duration-300`}></div>
                  </motion.div>
                );
              })}
            </motion.div>
        ...
        <section className="py-12 sm:py-16 md:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:gap-4 relative">
              {/* Connection lines */}
              <div className="hidden md:block absolute top-24 left-1/3 right-1/3 h-0.5 bg-emerald-500"></div>
              ...
              {steps.map((step, index) => (
                ...
                >
                  <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-emerald-500 text-white text-2xl font-bold mb-6 shadow-xl shadow-emerald-500/50">
                    {step.number}
                  </div>
        ...
        <section className="py-12 sm:py-16 md:py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="relative overflow-hidden bg-emerald-500 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 text-center shadow-2xl"
            >
              {/* Animated background */}
              ...
              <div className="relative z-10">
                ...
                <Link href="/dashboard" className="inline-block w-full sm:w-auto">
                  <button className="w-full sm:w-auto px-6 sm:px-10 py-3 sm:py-4 bg-white hover:bg-gray-100 text-emerald-600 text-base sm:text-lg font-bold rounded-xl transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105 flex items-center justify-center gap-2 mx-auto min-h-[48px]">
      ...
      <footer className="relative z-10 border-t border-gray-800 bg-gray-900/50 backdrop-blur-xl mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-gray-400">
            <p>&copy; 2024 BIS. Built for HyperLiquid.</p>
          </div>
        </div>
      </footer>
    </div>
